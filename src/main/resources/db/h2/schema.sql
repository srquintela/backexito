...
DROP TABLE habilidad IF EXISTS;
DROP TABLE personalidad IF EXISTS;
DROP TABLE identidad IF EXISTS;
DROP TABLE decision IF EXISTS;
DROP TABLE promedios IF EXISTS;
DROP TABLE razonamiento IF EXISTS;
DROP TABLE carrera IF EXISTS;
